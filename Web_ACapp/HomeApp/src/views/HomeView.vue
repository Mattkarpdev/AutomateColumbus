...
<template>
  <body>
    <header>
      <div>
        <div class="p-4 pt-4 text-3xl font-bold underline">
          Automate Columbus
        </div>
        <div>
          <ul class="" style="color: blue">
            ...
            <li>
              <a class="nav-link scrollto" href="#installationCalculator"
      ...
      <section class="d-flex justify-content-center p-4">
        <div class="container" style="opacity: 0.9">
          <h5 class="bg-dark p-5" style="color: rgb(236, 209, 241)">
            ...
            technology. We also offer community support as well as installation
            services to the Columbus and Dayton Ohio areas.
          </h5>
        </div>
      </section>

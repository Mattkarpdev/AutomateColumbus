<template>
  <div class="flex justify-center gap-20 bg-red-n/95">
    <img class="p-4 pt-6" src="../assets/AC iconLarge.png" />
    <div class="flex flex-col justify-center">
      ...
      <a href="sms:614-819-3796" class="flex gap-2 object-center p-3">
        <img class="h-10 w-10" src="../assets/🦆 icon _comment_.png" />
      ...
      >
        <img class="h-10 w-10" src="../assets/🦆 icon _envelope_.png" />
        <div class="p-2 font-main text-3xl font-normal text-white">
      ...
      <a
        ...
        class="flex gap-2 object-center p-3"
      >
        <img class="h-10 w-10" src="../assets/🦆 icon _discord_.png" />
        <div class="p-2 font-main text-3xl font-normal text-white">
